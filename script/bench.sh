...
for i in {1..3}; do
    ./sshash bench -i ec.k31.sshash >> results-$1/k31/regular-bench.log
done
for i in {1..3}; do
    ./sshash bench -i se.k31.sshash >> results-$1/k31/regular-bench.log
done
...
for i in {1..3}; do
    ./sshash bench -i ec.k31.canon.sshash >> results-$1/k31/canon-bench.log
done
for i in {1..3}; do
    ./sshash bench -i se.k31.canon.sshash >> results-$1/k31/canon-bench.log
done
...
for i in {1..3}; do
    ./sshash bench -i ec.k63.sshash >> results-$1/k63/regular-bench.log
done
for i in {1..3}; do
    ./sshash bench -i se.k63.sshash >> results-$1/k63/regular-bench.log
done
...
for i in {1..3}; do
    ./sshash bench -i ec.k63.canon.sshash >> results-$1/k63/canon-bench.log
done
for i in {1..3}; do
    ./sshash bench -i se.k63.canon.sshash >> results-$1/k63/canon-bench.log
done

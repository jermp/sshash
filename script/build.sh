...
rm -rf tmp_dir/; ./sshash build -i /mnt/hd2/pibiri/DNA/eulertigs/axolotl.k31.eulertigs.fa.gz -k 31 -m 21 -g 16 -t 64 --verbose -d tmp_dir -o axolotl.k31.sshash >> results-$1/k31/regular-build.log
...
rm -rf tmp_dir/; ./sshash build -i /mnt/hd2/pibiri/DNA/eulertigs/ncbi-virus.k31.eulertigs.fa.gz -k 31 -m 19 -g 16 -t 64 --verbose -d tmp_dir -o ncbi-virus.k31.sshash >> results-$1/k31/regular-build.log
...
rm -rf tmp_dir/; ./sshash build -i /mnt/hd2/pibiri/DNA/eulertigs/axolotl.k31.eulertigs.fa.gz -k 31 -m 21 -g 16 -t 64 --canonical --verbose -d tmp_dir -o axolotl.k31.canon.sshash >> results-$1/k31/canon-build.log
...
rm -rf tmp_dir/; ./sshash build -i /mnt/hd2/pibiri/DNA/eulertigs/ncbi-virus.k31.eulertigs.fa.gz -k 31 -m 19 -g 16 -t 64 --canonical --verbose -d tmp_dir -o ncbi-virus.k31.canon.sshash >> results-$1/k31/canon-build.log
...
rm -rf tmp_dir/; ./sshash build -i /mnt/hd2/pibiri/DNA/eulertigs/axolotl.k31.eulertigs.fa.gz -k 63 -m 25 -g 16 -t 64 --verbose -d tmp_dir -o axolotl.k63.sshash >> results-$1/k63/regular-build.log
...
rm -rf tmp_dir/; ./sshash build -i /mnt/hd2/pibiri/DNA/eulertigs/ncbi-virus.k63.eulertigs.fa.gz -k 63 -m 23 -g 16 -t 64 --verbose -d tmp_dir -o ncbi-virus.k63.sshash >> results-$1/k63/regular-build.log
...
rm -rf tmp_dir/; ./sshash build -i /mnt/hd2/pibiri/DNA/eulertigs/axolotl.k31.eulertigs.fa.gz -k 63 -m 25 -g 16 -t 64 --canonical --verbose -d tmp_dir -o axolotl.k63.canon.sshash >> results-$1/k63/canon-build.log
...
rm -rf tmp_dir/; ./sshash build -i /mnt/hd2/pibiri/DNA/eulertigs/ncbi-virus.k63.eulertigs.fa.gz -k 63 -m 23 -g 16 -t 64 --canonical --verbose -d tmp_dir -o ncbi-virus.k63.canon.sshash >> results-$1/k63/canon-build.log

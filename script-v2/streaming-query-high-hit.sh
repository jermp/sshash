...
./sshash query -i kestrel.k31.sshash -q ~/sshash_queries/SRR11449743.fastq.gz >> $1.regular.high-hit.streaming_query_log
# ./sshash query -i kestrel.k63.sshash -q ~/sshash_queries/SRR11449743.fastq.gz >> $1.regular.high-hit.streaming_query_log
...
./sshash query -i kestrel.k31.canon.sshash -q ~/sshash_queries/SRR11449743.fastq.gz >> $1.canon.high-hit.streaming_query_log
# ./sshash query -i kestrel.k63.canon.sshash -q ~/sshash_queries/SRR11449743.fastq.gz >> $1.canon.high-hit.streaming_query_log

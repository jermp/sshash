...
lookup_result dictionary<kmer_t, Endpoints>::lookup_uint_regular(kmer_t uint_kmer) const {
    auto mini_info = util::compute_minimizer(uint_kmer, m_k, m_m, m_hasher);
    return lookup_uint_regular(uint_kmer, mini_info);
}

template <class kmer_t, class Endpoints>
lookup_result dictionary<kmer_t, Endpoints>::lookup_uint_regular(kmer_t uint_kmer,                //
...
template <class kmer_t, class Endpoints>
lookup_result dictionary<kmer_t, Endpoints>::lookup_uint_canonical(kmer_t uint_kmer) const  //
{
...
template <class kmer_t, class Endpoints>
lookup_result dictionary<kmer_t, Endpoints>::lookup_uint_canonical(
    kmer_t uint_kmer, kmer_t uint_kmer_rc,
    minimizer_info mini_info) const  //
{
...
template <class kmer_t, class Endpoints>
lookup_result dictionary<kmer_t, Endpoints>::lookup(char const* string_kmer,
...
template <class kmer_t, class Endpoints>
lookup_result dictionary<kmer_t, Endpoints>::lookup_uint(kmer_t uint_kmer,
                                                         bool check_reverse_complement) const {
...
template <class kmer_t, class Endpoints>
bool dictionary<kmer_t, Endpoints>::is_member(char const* string_kmer,
                                              bool check_reverse_complement) const {
    return lookup(string_kmer, check_reverse_complement) != constants::invalid_uint64;
}
template <class kmer_t, class Endpoints>
bool dictionary<kmer_t, Endpoints>::is_member_uint(kmer_t uint_kmer,
                                                   bool check_reverse_complement) const {
    return lookup_uint(uint_kmer, check_reverse_complement) != constants::invalid_uint64;
}

template <class kmer_t, class Endpoints>
void dictionary<kmer_t, Endpoints>::access(uint64_t kmer_id, char* string_kmer) const {
    assert(kmer_id < num_kmers());
    m_buckets.access(kmer_id, string_kmer, m_k);
}

template <class kmer_t, class Endpoints>
uint64_t dictionary<kmer_t, Endpoints>::weight(uint64_t kmer_id) const {
    assert(kmer_id < num_kmers());
    return m_weights.weight(kmer_id);
}

template <class kmer_t, class Endpoints>
uint64_t dictionary<kmer_t, Endpoints>::contig_size(uint64_t contig_id) const {
...
template <class kmer_t, class Endpoints>
void dictionary<kmer_t, Endpoints>::forward_neighbours(kmer_t suffix, neighbourhood<kmer_t>& res,
                                                       bool check_reverse_complement) const {
...
template <class kmer_t, class Endpoints>
void dictionary<kmer_t, Endpoints>::backward_neighbours(kmer_t prefix, neighbourhood<kmer_t>& res,
                                                        bool check_reverse_complement) const {
    for (size_t i = 0; i < kmer_t::alphabet_size; i++) {
...
template <class kmer_t, class Endpoints>
neighbourhood<kmer_t> dictionary<kmer_t, Endpoints>::kmer_forward_neighbours(
...
template <class kmer_t, class Endpoints>
kmer_t dictionary<kmer_t, Endpoints>::get_suffix(kmer_t kmer) const {
    kmer_t suffix = kmer;
    suffix.drop_char();
    return suffix;
}
...
template <class kmer_t, class Endpoints>
neighbourhood<kmer_t> dictionary<kmer_t, Endpoints>::kmer_backward_neighbours(
    char const* string_kmer, bool check_reverse_complement) const {
    kmer_t uint_kmer = util::string_to_uint_kmer<kmer_t>(string_kmer, m_k);
...
template <class kmer_t, class Endpoints>
kmer_t dictionary<kmer_t, Endpoints>::get_prefix(kmer_t kmer) const {
    kmer_t prefix = kmer;
    prefix.pad_char();
...
template <class kmer_t, class Endpoints>
neighbourhood<kmer_t> dictionary<kmer_t, Endpoints>::kmer_neighbours(
    char const* string_kmer, bool check_reverse_complement) const {
    kmer_t uint_kmer = util::string_to_uint_kmer<kmer_t>(string_kmer, m_k);
...
template <class kmer_t, class Endpoints>
neighbourhood<kmer_t> dictionary<kmer_t, Endpoints>::contig_neighbours(
    uint64_t contig_id, bool check_reverse_complement) const {
    assert(contig_id < num_strings());
    neighbourhood<kmer_t> res;
...
template <class kmer_t, class Endpoints>
uint64_t dictionary<kmer_t, Endpoints>::num_bits() const {
